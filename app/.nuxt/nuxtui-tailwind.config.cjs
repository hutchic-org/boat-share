      ...
      const { customSafelistExtractor, generateSafelist } = require("/src/node_modules/@nuxt/ui/dist/runtime/utils/colors")
      ...
      module.exports = {
        ...
        content: {
          files: [
            "/src/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "/src/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
